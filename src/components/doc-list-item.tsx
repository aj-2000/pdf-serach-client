...
export default function DocListItem({ pdf }: { pdf: PdfFile }) {
  return (
    <div
      ...
      className="flex flex-row items-center border border-border hover:border hover:border-primary hover:cursor-pointer justify-between rounded-lg bg-card p-3 shadow-sm w-full"
    >
